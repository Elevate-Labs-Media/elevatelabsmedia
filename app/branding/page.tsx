...
const services = [
  {
    ...
    description:
      "Define your brand's purpose, positioning, and voice to guide all communication and design efforts.",
  },
  {
    title: "Rebranding",
    description:
      "Refresh and evolve your brand to stay relevant and aligned with your business growth.",
  },
  {
    title: "Visual Identity Design",
    description:
      "Create cohesive visuals—logos, color palettes, and typography—that reflect your brand's personality.",
  },
  {
    title: "Brand Messaging",
    description:
      "Craft compelling taglines, tone of voice, and storytelling that resonates with your audience.",
  },
  {
    title: "Brand Guidelines",
    description:
      "Ensure consistency across all touchpoints with a clear, easy-to-follow brand style guide.",
  },
];
      ...
      <main className="bg-background text-white min-h-screen pt-24 pb-20 relative z-10 overflow-hidden">
        ...
        <section className="relative px-4 md:px-10 py-20 md:py-32 z-10 flex flex-col items-center justify-center min-h-[50vh]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <span className="text-primary italic">Branding</span>
            </motion.h1>
            ...
            >
              We craft distinctive brand identities that communicate your
              vision, connect with your audience, and leave a lasting
              impression.
              <br className="hidden md:block" />
              Logo design, identity systems, and brand storytelling to create
